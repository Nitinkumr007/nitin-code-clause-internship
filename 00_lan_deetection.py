...
# image = cv2.imread('E:\code code code\open_cv\Road.jpg')
...
def process(image):
      ...
      region_of_interest_vertices = [(0, height),(width/1.9, height/2.3), (width, height)]
      ...
      def drow_the_line(img,lines):
          ...
          for line in lines:
              for x1,y1,x2,y2 in line:
                  cv2.line(blank_image,(x1,y1),(x2,y2),(225,000,115),thickness=6)
